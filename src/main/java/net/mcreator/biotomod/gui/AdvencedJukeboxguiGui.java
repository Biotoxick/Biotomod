...
import net.mcreator.biotomod.procedures.SetOnProcedure;
import net.mcreator.biotomod.procedures.SetOffProcedure;
...
public class AdvencedJukeboxguiGui extends BiotomodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public AdvencedJukeboxguiGui(BiotomodModElements instance) {
		super(instance, 295);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("advenced_jukeboxgui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AdvencedJukeboxguiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 79, 60) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		if (buttonID == 0) {
			{
				...
				SetOnProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SetOffProcedure.executeProcedure($_dependencies);
			}
		}
	}
