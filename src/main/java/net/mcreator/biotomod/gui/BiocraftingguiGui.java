...
public class BiocraftingguiGui extends BiotomodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BiocraftingguiGui(BiotomodModElements instance) {
		super(instance, 22);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("biocraftinggui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, BiocraftingguiGuiWindow::new));
	}
		...
		if (buttonID == 0) {
			{
				...
				GuihelpplatinumcrafterProcedure.executeProcedure($_dependencies);
			}
		}
	}
