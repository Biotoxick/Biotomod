...
public class PlatiniumOreBlock extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:platinium_ore")
	public static final Block block = null;
	public PlatiniumOreBlock(BiotomodModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.4000000000000001f, 15f).setLightLevel(s -> 4)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("biotomod:platinium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("biotomod:platinium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
