...
import net.mcreator.biotomod.item.ParallelicItem;
...
public class ParallelicOreBlock extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:parallelic_ore")
	public static final Block block = null;
	public ParallelicOreBlock(BiotomodModElements instance) {
		super(instance, 143);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("parallelic_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ParallelicItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("biotomod:parallelic_ore_match"), () -> CustomRuleTest.codec);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("biotomod:biotobiome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
