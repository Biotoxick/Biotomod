...
public class ParallelicBlockBlock extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:parallelic_block")
	public static final Block block = null;
	public ParallelicBlockBlock(BiotomodModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("parallelic_block");
		}
