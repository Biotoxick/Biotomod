		...
		if (((new Object() {
			...
			if (((new Object() {
				...
				if ((new Object() {
					...
					}.getEnergyStored(world, new BlockPos((int) x, (int) y, (int) (z - 1)))) > 500)) {
			...
			if (((new Object() {
				...
				if ((new Object() {
					public boolean canExtractEnergy(IWorld world, BlockPos pos) {
						...
						TileEntity _ent = world.getTileEntity(pos);
						if (_ent != null)
							_ent.getCapability(CapabilityEnergy.ENERGY, Direction.EAST).ifPresent(capability -> _retval.set(capability.canExtract()));
						return _retval.get();
					}
					...
					}.getEnergyStored(world, new BlockPos((int) (x + 1), (int) y, (int) z))) > 500)) {
						south = (double) (new Object() {
							public int extractEnergySimulate(IWorld world, BlockPos pos, int _amount) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
			...
			if (((new Object() {
				...
				if ((new Object() {
					public boolean canExtractEnergy(IWorld world, BlockPos pos) {
						...
						TileEntity _ent = world.getTileEntity(pos);
						if (_ent != null)
							_ent.getCapability(CapabilityEnergy.ENERGY, Direction.WEST).ifPresent(capability -> _retval.set(capability.canExtract()));
						return _retval.get();
					}
				}.canExtractEnergy(world, new BlockPos((int) (x - 1), (int) y, (int) z)))) {
					if (((new Object() {
