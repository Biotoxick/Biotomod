...
public class TeleporterBlocrunningprocedureProcedure extends BiotomodModElements.ModElement {
	public TeleporterBlocrunningprocedureProcedure(BiotomodModElements instance) {
		super(instance, 66);
	}
