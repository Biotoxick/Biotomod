...
public class Somprocesst2Procedure extends BiotomodModElements.ModElement {
	public Somprocesst2Procedure(BiotomodModElements instance) {
		super(instance, 206);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BiotomodMod.LOGGER.warn("Failed to load dependency x for procedure Somprocesst2!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BiotomodMod.LOGGER.warn("Failed to load dependency y for procedure Somprocesst2!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BiotomodMod.LOGGER.warn("Failed to load dependency z for procedure Somprocesst2!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BiotomodMod.LOGGER.warn("Failed to load dependency world for procedure Somprocesst2!");
			return;
		}
		...
		if (!world.isRemote()) {
			...
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("cost", 1500);
