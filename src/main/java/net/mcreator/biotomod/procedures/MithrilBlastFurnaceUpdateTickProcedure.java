...
public class MithrilBlastFurnaceUpdateTickProcedure extends BiotomodModElements.ModElement {
	public MithrilBlastFurnaceUpdateTickProcedure(BiotomodModElements instance) {
		super(instance, 127);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BiotomodMod.LOGGER.warn("Failed to load dependency x for procedure MithrilBlastFurnaceUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BiotomodMod.LOGGER.warn("Failed to load dependency y for procedure MithrilBlastFurnaceUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BiotomodMod.LOGGER.warn("Failed to load dependency z for procedure MithrilBlastFurnaceUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BiotomodMod.LOGGER.warn("Failed to load dependency world for procedure MithrilBlastFurnaceUpdateTick!");
			return;
		}
