...
public class Cansendenergy3Procedure extends BiotomodModElements.ModElement {
	public Cansendenergy3Procedure(BiotomodModElements instance) {
		super(instance, 274);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BiotomodMod.LOGGER.warn("Failed to load dependency x for procedure Cansendenergy3!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BiotomodMod.LOGGER.warn("Failed to load dependency y for procedure Cansendenergy3!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BiotomodMod.LOGGER.warn("Failed to load dependency z for procedure Cansendenergy3!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BiotomodMod.LOGGER.warn("Failed to load dependency world for procedure Cansendenergy3!");
			return;
		}
		...
		if (((rf) >= 500)) {
			if (((new Object() {
				...
				if ((new Object() {
					...
					}.receiveEnergySimulate(world, new BlockPos((int) x, (int) (y + 1), (int) z), (int) 500));
					{
			...
			if (((new Object() {
				...
				if ((new Object() {
					...
					}.receiveEnergySimulate(world, new BlockPos((int) (x + 1), (int) y, (int) z), (int) 500));
					{
			...
			if (((new Object() {
				...
				if ((new Object() {
					...
					}.receiveEnergySimulate(world, new BlockPos((int) x, (int) y, (int) (z - 1)), (int) 500));
					{
