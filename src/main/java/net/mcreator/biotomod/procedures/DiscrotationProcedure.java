...
public class DiscrotationProcedure extends BiotomodModElements.ModElement {
	public DiscrotationProcedure(BiotomodModElements instance) {
		super(instance, 306);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BiotomodMod.LOGGER.warn("Failed to load dependency x for procedure Discrotation!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BiotomodMod.LOGGER.warn("Failed to load dependency y for procedure Discrotation!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BiotomodMod.LOGGER.warn("Failed to load dependency z for procedure Discrotation!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BiotomodMod.LOGGER.warn("Failed to load dependency world for procedure Discrotation!");
			return;
		}
		...
		new Object() {
			...
			private void run() {
				if (((new Object() {
					...
					}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (5))) == 0)) {
						{
							TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
								final int _sltid = (int) (5);
		...
		new Object() {
			...
			private void run() {
				if (((new Object() {
					...
					}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (6))) == 0)) {
						{
							TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
								final int _sltid = (int) (6);
		...
		new Object() {
			...
			private void run() {
				if (((new Object() {
					...
					}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (7))) == 0)) {
						{
							TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
								final int _sltid = (int) (7);
