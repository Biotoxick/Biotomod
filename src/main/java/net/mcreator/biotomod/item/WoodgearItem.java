...
public class WoodgearItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:woodgear")
	public static final Item block = null;
	public WoodgearItem(BiotomodModElements instance) {
		super(instance, 80);
	}
