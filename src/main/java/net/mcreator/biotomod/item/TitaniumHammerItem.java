...
public class TitaniumHammerItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:titanium_hammer")
	public static final Item block = null;
	public TitaniumHammerItem(BiotomodModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}, 1, -2.9f, new Item.Properties().group(BiotomodItemGroup.tab).isImmuneToFire()) {
			@Override
		...
		}.setRegistryName("titanium_hammer"));
	}
}
