...
public class MithrilIngotItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:mithril_ingot")
	public static final Item block = null;
	public MithrilIngotItem(BiotomodModElements instance) {
		super(instance, 6);
	}
