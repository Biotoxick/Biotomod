...
public class PlatiniumItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:platinium")
	public static final Item block = null;
	public PlatiniumItem(BiotomodModElements instance) {
		super(instance, 8);
	}
