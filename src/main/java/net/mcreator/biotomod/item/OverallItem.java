...
public class OverallItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:overall")
	public static final Item block = null;
	public OverallItem(BiotomodModElements instance) {
		super(instance, 291);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, BiotomodModElements.sounds.get(new ResourceLocation("biotomod:overall")),
					new Item.Properties().group(BiotomodItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("overall");
		}
