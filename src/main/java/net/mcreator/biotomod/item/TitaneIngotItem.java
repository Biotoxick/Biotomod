...
public class TitaneIngotItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:titane_ingot")
	public static final Item block = null;
	public TitaneIngotItem(BiotomodModElements instance) {
		super(instance, 4);
	}
