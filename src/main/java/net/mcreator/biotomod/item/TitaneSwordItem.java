...
public class TitaneSwordItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:titane_sword")
	public static final Item block = null;
	public TitaneSwordItem(BiotomodModElements instance) {
		super(instance, 152);
	}
