...
public class TitaniumArmorItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:titanium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("biotomod:titanium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("biotomod:titanium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("biotomod:titanium_armor_boots")
	public static final Item boots = null;
	public TitaniumArmorItem(BiotomodModElements instance) {
		super(instance, 18);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(BiotomodItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "biotomod:textures/models/armor/titanium_armor_texture_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
