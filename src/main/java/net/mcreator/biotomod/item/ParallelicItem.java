...
public class ParallelicItem extends BiotomodModElements.ModElement {
	@ObjectHolder("biotomod:parallelic")
	public static final Item block = null;
	public ParallelicItem(BiotomodModElements instance) {
		super(instance, 142);
	}
